document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Produkte der Kategorie wNeck anzeigen
    const productList = document.getElementById('wNeck-list');
    
    const filteredProducts = products.filter(product => product.category === 'wNeck');
